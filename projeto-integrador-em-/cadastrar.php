...
$email = $_POST["email"];
$senha = $_POST["senha"];
//$confirmarsenha = $_POST["consfirmarsenha"];   


  $sql = $pdo->prepare("INSERT INTO usuario (id, nome, nickname, email, senha )
  values (null,?,?,?,?)");

if ($sql->execute(array($nome, $nickname, $email, $senha ))) {
  ...
  <div class="container">
    <form method="POST">
      <div class="form-group">
        ...
        <input type="name" class="form-control"  name= "nome" id="nome" placeholder="Nome">
      </div>
      <div class="form-group">
